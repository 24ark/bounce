...
newBlock.myName = "first crate"
newBlock.collision = onLocalCollision
 newBlock:addEventListener( "collision", newBlock )
...
physics.addBody(sprite, "static", {bounce=1,radius=15})
